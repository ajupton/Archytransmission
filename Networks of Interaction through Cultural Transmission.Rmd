...
In my next post on this subject, I'll discuss how to analyze networks such as these using a variety of routines in the igraph package as well as how to understand the results using Monte Carlo similations based on network randomization. Also coming is a post describing how to combine these networks together in a multilayer network analysis. For a full description of the methods used and interpretations, you'll have to wait for my dissertation to be defended. That's coming later in 2018. 
...
vsizejpost <- rep.int(.25, 7)
vsizeppre <- rep.int(.25, 11)
vsizeppost <- rep.int(.25, 6)
...
graphjs(jgpostvis, edge.color = colfunc(31), edge.width = 2.5, vertex.shape = V(jgpostvis)$name, vertex.size = vsizejpost, edge.alpha = 0.7)  

# -----Graph of jars across time------
graphjs(jgvis, edge.color = colfunc(112), edge.width = 2.5, vertex.shape = V(jgvis)$name, vertex.size = vsizejall, edge.alpha = 0.7) 
...
graphjs(pgpostvis, edge.width = 2.5, edge.color = colfunc(29), vertex.shape = V(pgpostvis)$name, vertex.size = vsizeppost, edge.alpha = 0.7) 

# ------Graph of plates across time------
graphjs(pgvis, edge.width = 2.5, edge.color = colfunc(92), vertex.shape = V(pgvis)$name, vertex.size = vsizepall, edge.alpha = 0.7) 
